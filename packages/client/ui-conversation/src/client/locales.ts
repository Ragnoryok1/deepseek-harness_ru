...
const PLAN_NEXT_ACTION_RU = 'опишите вашу задачу, чтобы составить план'
...
export const ru = {
  ...
  'stats.counts': 'Раундов: {turns} · Шагов: {steps}',
  'stats.llm': 'LLM {duration}',
  ...
  'details.empty': 'Нажмите на строку инструмента в потоке сообщений, чтобы увидеть детали',
  ...
  'message.contextRecall': 'Реколл сессии',
  ...
  'message.context.catalog.replaced': 'Замена каталога',
  ...
  'message.branch': 'Ветвление в новый диалог',
  'message.branchUnavailable': 'Доступно только для последнего сообщения завершённого раунда',
  ...
  'message.turnError': 'Этот раунд завершился с ошибкой',
  'message.maxTokens': 'Достигнут лимит выходных токенов',
  'message.maxTokens.hint': 'Ответ обрезан; предыдущий вывод сохранён в диалоге. Отправьте «продолжить», чтобы модель продолжила.',
